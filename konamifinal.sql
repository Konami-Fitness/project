...
(1003, '14.00', 1, 'Bicycling, mountain, uphill, vigorous'),
(1004, '16.00', 1, 'Bicycling, mountain, competitive, racing'),
(1008, '8.50', 1, 'Bicycling, BMX'),
(1009, '8.50', 1, 'Bicycling, mountain, general'),
(1010, '4.00', 1, 'Bicycling, <10 mph, leisure, to work or for pleasure (Taylor Code 115)'),
(1011, '6.80', 1, 'Bicycling, to/from work, self selected pace'),
(1013, '5.80', 1, 'Bicycling, on dirt or farm road, moderate pace'),
(1015, '7.50', 1, 'Bicycling, general'),
(1018, '3.50', 1, 'Bicycling, leisure, 5.5 mph'),
(1019, '5.80', 1, 'Bicycling, leisure, 9.4 mph'),
(1020, '6.80', 1, 'Bicycling, 10-11.9 mph, leisure, slow, light effort'),
(1030, '8.00', 1, 'Bicycling, 12-13.9 mph, leisure, moderate effort'),
(1040, '10.00', 1, 'Bicycling, 14-15.9 mph, racing or leisure, fast, vigorous effort'),
(1050, '12.00', 1, 'Bicycling, 16-19 mph, racing/not drafting or > 19 mph drafting, very fast, racing general'),
(1060, '15.80', 1, 'Bicycling, > 20 mph, racing, not drafting'),
(1065, '8.50', 1, 'Bicycling, 12 mph, seated, hands on brake hoods or bar drops, 80 rpm'),
(1066, '9.00', 1, 'Bicycling, 12 mph, standing, hands on brake hoods, 60 rpm'),
(1070, '5.00', 1, 'Unicycling'),
(2001, '2.30', 2, 'Activity promoting video game (e.g., Wii Fit), light effort (e.g., balance, yoga)'),
(2003, '3.80', 2, 'Activity promoting video game (e.g., Wii Fit), moderate effort (e.g., aerobic, resistance)'),
(2005, '7.20', 2, 'Activity promoting video/arcade game (e.g., Exergaming, Dance Dance Revolution), vigorous effort'),
(2008, '5.00', 2, 'Army type obstacle course exercise, boot camp training program'),
(2010, '7.00', 2, 'Bicycling, stationary, general'),
(2011, '3.50', 2, 'Bicycling, stationary, 30-50 watts, very light to light effort'),
(2012, '6.80', 2, 'Bicycling, stationary, 90-100 watts, moderate to vigorous effort'),
(2013, '8.80', 2, 'Bicycling, stationary, 101-160 watts, vigorous effort'),
(2014, '11.00', 2, 'Bicycling, stationary, 161-200 watts, vigorous effort'),
(2015, '14.00', 2, 'Bicycling, stationary, 201-270 watts, very vigorous effort'),
(2017, '4.80', 2, 'Bicycling, stationary, 51-89 watts, light-to-moderate effort'),
(2019, '8.50', 2, 'Bicycling, stationary, RPM/Spin bike class'),
(2020, '8.00', 2, 'Calisthenics (e.g., push ups, sit ups, pull-ups, jumping jacks), vigorous effort'),
(2022, '3.80', 2, 'Calisthenics (e.g., push ups, sit ups, pull-ups, lunges), moderate effort'),
(2024, '2.80', 2, 'Calisthenics (e.g., situps, abdominal crunches), light effort'),
(2030, '3.50', 2, 'Calisthenics, light or moderate effort, general (e.g., back exercises), going up & down from floor (Taylor Code 150)'),
(2035, '4.30', 2, 'Circuit training, moderate effort'),
(2040, '8.00', 2, 'Circuit training, including kettlebells, some aerobic movement with minimal rest, general, vigorous intensity'),
(2045, '3.50', 2, 'Curves(TM) Eexercise routines in women'),
(2048, '5.00', 2, 'Elliptical trainer, moderate effort'),
(2050, '6.00', 2, 'Resistance training (weight lifting, free weight, nautilus or universal), power lifting or body building, vigorous effort (Taylor Code 210)'),
(2052, '5.00', 2, 'Resistance (weight) training, squats , slow or explosive effort'),
(2054, '3.50', 2, 'Resistance (weight) training, multiple exercises, 8-15 repetitions at varied resistance'),
(2060, '5.50', 2, 'Health club exercise, general (Taylor Code 160)'),
(2061, '5.00', 2, 'Health club exercise classes, general, gym/weight training combined in one visit'),
(2062, '7.80', 2, 'Health club exercise, conditioning classes'),
(2064, '3.80', 2, 'Home exercise, general'),
(2065, '9.00', 2, 'Stair-treadmill ergometer, general'),
(2068, '12.30', 2, 'Rope skipping, general'),
(2070, '6.00', 2, 'Rowing, stationary ergometer, general, vigorous effort'),
(2071, '4.80', 2, 'Rowing, stationary, general, moderate effort'),
(2072, '7.00', 2, 'Rowing, stationary, 100 watts, moderate effort'),
(2073, '8.50', 2, 'Rowing, stationary, 150 watts, vigorous effort'),
(2074, '12.00', 2, 'Rowing, stationary, 200 watts, very vigorous effort'),
(2080, '6.80', 2, 'Ski machine, general'),
(2085, '11.00', 2, 'Slide board exercise, general'),
(2090, '6.00', 2, 'Slimnastics, Jazzercise'),
(2101, '2.30', 2, 'Stretching, mild'),
(2105, '3.00', 2, 'Pilates, general'),
(2110, '6.80', 2, 'Teaching exercise class (e.g., aerobic, water)'),
(2112, '2.80', 2, 'Therapeutic exercise ball, Fitball exercise'),
(2115, '2.80', 2, 'Upper body exercise, arm ergometer'),
(2117, '4.30', 2, 'Upper body exercise, stationary bicycle - Airdyne (arms only) 40 rpm, moderate'),
(2120, '5.30', 2, 'Water aerobics, water calisthenics, water exercise'),
(2135, '1.30', 2, 'Whirlpool, sitting'),
(2140, '2.30', 2, 'Video exercise workouts, TV conditioning programs (e.g., yoga, stretching), light effort'),
(2143, '4.00', 2, 'Video exercise workouts, TV conditioning programs (e.g., cardio-resistance), moderate effort'),
(2146, '6.00', 2, 'Video exercise workouts, TV conditioning programs (e.g., cardio-resistance), vigorous effort'),
(2150, '2.50', 2, 'Yoga, Hatha'),
(2160, '4.00', 2, 'Yoga, Power'),
(2170, '2.00', 2, 'Yoga, Nadisodhana'),
(2180, '3.30', 2, 'Yoga, Surya Namaskar'),
(2200, '5.30', 2, 'Native New Zealander physical activities (e.g., Haka Powhiri, Moteatea, Waita Tira, Whakawatea, etc.), general, moderate effort'),
(2205, '6.80', 2, 'Native New Zealander physical activities (e.g., Haka, Taiahab), general, vigorous effort'),
(3010, '5.00', 3, 'Ballet, modern, or jazz, general, rehearsal or class'),
(3012, '6.80', 3, 'Ballet, modern, or jazz, performance, vigorous effort'),
(3014, '4.80', 3, 'Tap'),
(3015, '7.30', 3, 'Aerobic, general'),
(3016, '7.50', 3, 'Aerobic, step, with 6 - 8 inch step'),
(3017, '9.50', 3, 'Aerobic, step, with 10 - 12 inch step'),
(3018, '5.50', 3, 'Aerobic, step, with 4-inch step'),
(3019, '8.50', 3, 'Bench step class, general'),
(3020, '5.00', 3, 'Aerobic, low impact'),
(3021, '7.30', 3, 'Aerobic, high impact'),
(3022, '10.00', 3, 'Aerobic dance wearing 10-15 lb weights'),
(3025, '4.50', 3, 'Ethnic or cultural dancing (e.g., Greek, Middle Eastern, hula, salsa, merengue, bamba y plena, flamenco, belly, and swing)'),
(3030, '5.50', 3, 'Ballroom, fast (Taylor Code 125)'),
(3031, '7.80', 3, 'General dancing (e.g., disco, folk, Irish step dancing, line dancing, polka, contra, country)'),
(3038, '11.30', 3, 'Ballroom dancing, competitive, general'),
(3040, '3.00', 3, 'Ballroom, slow (e.g., waltz, foxtrot, slow dancing, samba, tango, 19th century dance, mambo, cha cha)'),
(3050, '5.50', 3, 'Anishinaabe Jingle Dancing'),
(3060, '3.50', 3, 'Caribbean dance (Abakua, Beguine, Bellair, Bongo, Brukin\'s, Caribbean Quadrills, Dinki Mini, Gere, Gumbay, Ibo, Jonkonnu, Kumina, Oreisha, Jambu)'),
(4001, '3.50', 4, 'Fishing, general'),
(4005, '4.50', 4, 'Fishing, crab fishing'),
(4007, '4.00', 4, 'Fishing, catching fish with hands'),
(4010, '4.30', 4, 'Fishing related, digging worms, with shovel'),
(4020, '4.00', 4, 'Fishing from river bank and walking'),
(4030, '2.00', 4, 'Fishing from boat or canoe, sitting'),
(4040, '3.50', 4, 'Fishing from river bank, standing (Taylor Code 660)'),
(4050, '6.00', 4, 'Fishing in stream, in waders (Taylor Code 670)'),
(4060, '2.00', 4, 'Fishing, ice, sitting'),
(4061, '1.80', 4, 'Fishing, jog or line, standing, general'),
(4062, '3.50', 4, 'Fishing, dip net, setting net and retrieving fish, general'),
(4063, '3.80', 4, 'Fishing, set net, setting net and retrieving fish, general'),
(4064, '3.00', 4, 'Fishing, fishing wheel, setting net and retrieving fish, general'),
(4065, '2.30', 4, 'Fishing with a spear, standing'),
(4070, '2.50', 4, 'Hunting, bow and arrow, or crossbow'),
(4080, '6.00', 4, 'Hunting, deer, elk, large game (Taylor Code 170)'),
(4081, '11.30', 4, 'Hunting large game, dragging carcass'),
(4083, '4.00', 4, 'Hunting large marine animals'),
(4085, '2.50', 4, 'Hunting large game, from a hunting stand, limited walking'),
(4086, '2.00', 4, 'Hunting large game from a car, plane, or boat'),
(4090, '2.50', 4, 'Hunting, duck, wading'),
(4095, '3.00', 4, 'Hunting, flying fox, squirrel'),
(4100, '5.00', 4, 'Hunting, general'),
(4110, '6.00', 4, 'Hunting, pheasants or grouse (Taylor Code 680)'),
(4115, '3.30', 4, 'Hunting, birds'),
(4120, '5.00', 4, 'Hunting, rabbit, squirrel, prairie chick, raccoon, small game (Taylor Code 690)'),
(4123, '3.30', 4, 'Hunting, pigs, wild'),
(4124, '2.00', 4, 'Trapping game, general'),
(4125, '9.50', 4, 'Hunting, hiking with hunting gear'),
(4130, '2.50', 4, 'Pistol shooting or trap shooting, standing'),
(4140, '2.30', 4, 'Rifle exercises, shooting, lying down'),
(4145, '2.50', 4, 'Rifle exercises, shooting, kneeling or standing'),
(5010, '3.30', 5, 'Cleaning, sweeping carpet or floors, general'),
(5011, '2.30', 5, 'Cleaning, sweeping, slow, light effort'),
(5012, '3.80', 5, 'Cleaning, sweeping, slow, moderate effort'),
(5020, '3.50', 5, 'Cleaning, heavy or major (e.g. wash car, wash windows, clean garage), moderate effort'),
(5021, '3.50', 5, 'Cleaning, mopping, standing, moderate effort'),
(5022, '3.20', 5, 'Cleaning windows, washing windows, general'),
(5023, '2.50', 5, 'Mopping, standing, light effort'),
(5024, '4.50', 5, 'Polishing floors, standing, walking slowly, using electric polishing machine'),
(5025, '2.80', 5, 'Multiple household tasks all at once, light effort'),
(5026, '3.50', 5, 'Multiple household tasks all at once, moderate effort'),
(5027, '4.30', 5, 'Multiple household tasks all at once, vigorous effort'),
(5030, '3.30', 5, 'Cleaning, house or cabin, general, moderate effort'),
(5032, '2.30', 5, 'Dusting or polishing furniture, general'),
(5035, '3.30', 5, 'Kitchen activity, general, (e.g., cooking, washing dishes, cleaning up), moderate effort'),
(5040, '2.50', 5, 'Cleaning, general (straightening up, changing linen, carrying out trash, light effort'),
(5041, '1.80', 5, 'Wash dishes, standing or in general (not broken into stand/walk components)'),
(5042, '2.50', 5, 'Wash dishes, clearing dishes from table, walking, light effort'),
(5043, '3.30', 5, 'Vacuuming, general, moderate effort'),
(5044, '3.00', 5, 'Butchering animals, small'),
(5045, '6.00', 5, 'Butchering animal, large, vigorous effort'),
(5046, '2.30', 5, 'Cutting and smoking fish, drying fish or meat'),
(5048, '4.00', 5, 'Tanning hides, general'),
(5049, '3.50', 5, 'Cooking or food preparation, moderate effort'),
(5050, '2.00', 5, 'Cooking or food preparation - standing or sitting or in general (not broken into stand/walk components), manual appliances, light effort'),
(5051, '2.50', 5, 'Serving food, setting table, implied walking or standing'),
(5052, '2.50', 5, 'Cooking or food preparation, walking'),
(5053, '2.50', 5, 'Feeding household animals'),
(5055, '2.50', 5, 'Putting away groceries (e.g. carrying groceries, shopping without a grocery cart), carrying packages'),
(5056, '7.50', 5, 'Carrying groceries upstairs'),
(5057, '3.00', 5, 'Cooking Indian bread on an outside stove'),
(5060, '2.30', 5, 'Food shopping with or without a grocery cart, standing or walking'),
(5065, '2.30', 5, 'Non-food shopping, with or without a cart, standing or walking'),
(5070, '1.80', 5, 'Ironing'),
(5080, '1.30', 5, 'Knitting, sewing, light effort, wrapping presents, sitting'),
(5082, '2.80', 5, 'Sewing with a machine'),
(5090, '2.00', 5, 'Laundry, fold or hang clothes, put clothes in washer or dryer, packing suitcase, washing clothes by hand, implied standing, light effort'),
(5092, '4.00', 5, 'Laundry, hanging wash, washing clothes by hand, moderate effort'),
(5095, '2.30', 5, 'Laundry, putting away clothes, gathering clothes to pack, putting away laundry, implied walking'),
(5100, '3.30', 5, 'Making bed, changing linens'),
(5110, '5.00', 5, 'Maple syruping/sugar bushing (including carrying buckets, carrying wood)'),
(5120, '5.80', 5, 'Moving furniture, household items, carrying boxes'),
(5121, '5.00', 5, 'Moving, lifting light loads'),
(5125, '4.80', 5, 'Organizing room'),
(5130, '3.50', 5, 'Scrubbing floors, on hands and knees, scrubbing bathroom, bathtub, moderate effort'),
(5131, '2.00', 5, 'Scrubbing floors, on hands and knees, scrubbing bathroom, bathtub, light effort'),
(5132, '6.50', 5, 'Scrubbing floors, on hands and knees, scrubbing bathroom, bathtub, vigorous effort'),
(5140, '4.00', 5, 'Sweeping garage, sidewalk or outside of house'),
(5146, '3.50', 5, 'Standing, packing/unpacking boxes, occasional lifting of lightweight household items, loading or unloading items in car, moderate effort'),
(5147, '3.00', 5, 'Implied walking, putting away household items, moderate effort'),
(5148, '2.50', 5, 'Watering plants'),
(5149, '2.50', 5, 'Building a fire inside'),
(5150, '9.00', 5, 'Moving household items upstairs, carrying boxes or furniture'),
(5160, '2.00', 5, 'Standing, light effort tasks (pump gas, change light bulb, etc.)'),
(5165, '3.50', 5, 'Walking, moderate effort tasks, non-cleaning (readying to leave, shut/lock doors, close windows, etc.)'),
(5170, '2.20', 5, 'Sitting, playing with child(ren), light effort, only active periods'),
(5171, '2.80', 5, 'Standing, playing with child(ren) light effort, only active periods'),
(5175, '3.50', 5, 'Walking/running, playing with child(ren), moderate effort, only active periods'),
(5180, '5.80', 5, 'Walking/running, playing with child(ren), vigorous effort, only active periods'),
(5181, '3.00', 5, 'Walking and carrying small child, child weighing 15 lbs or more'),
(5182, '2.30', 5, 'Walking and carrying small child, child weighing less than 15 lbs'),
(5183, '2.00', 5, 'Standing, holding child'),
(5184, '2.50', 5, 'Child care, infant, general'),
(5185, '2.00', 5, 'Child care, sitting/kneeling (e.g., dressing, bathing, grooming, feeding, occasional lifting of child), light effort, general'),
(5186, '3.00', 5, 'Child care, standing (e.g., dressing, bathing, grooming, feeding, occasional lifting of child), moderate effort'),
(5188, '1.50', 5, 'Reclining with baby'),
(5189, '2.00', 5, 'Breastfeeding, sitting or reclining'),
(5190, '2.50', 5, 'Sit, playing with animals, light effort, only active periods'),
(5191, '2.80', 5, 'Stand, playing with animals, light effort, only active periods'),
(5192, '3.00', 5, 'Walk/run, playing with animals, general, light effort, only active periods'),
(5193, '4.00', 5, 'Walk/run, playing with animals, moderate effort, only active periods'),
(5194, '5.00', 5, 'Walk/run, playing with animals, vigorous effort, only active periods'),
(5195, '3.50', 5, 'Standing, bathing dog'),
(5197, '2.30', 5, 'Animal care, household animals, general'),
(5200, '4.00', 5, 'Elder care, disabled adult, bathing, dressing, moving into and out of bed, only active periods'),
(5205, '2.30', 5, 'Elder care, disabled adult, feeding, combing hair, light effort, only active periods'),
(6010, '3.00', 6, 'Airplane repair'),
(6020, '4.00', 6, 'Automobile body work'),
(6030, '3.30', 6, 'Automobile repair, light or moderate effort'),
(6040, '3.00', 6, 'Carpentry, general, workshop (Taylor Code 620)'),
(6050, '6.00', 6, 'Carpentry, outside house, installing rain gutters (Taylor Code 640),carpentry, outside house, building a fence'),
(6052, '3.80', 6, 'Carpentry, outside house, building a fence'),
(6060, '3.30', 6, 'Carpentry, finishing or refinishing cabinets or furniture'),
(6070, '6.00', 6, 'Carpentry, sawing hardwood'),
(6072, '4.00', 6, 'Carpentry, home remodeling tasks, moderate effort'),
(6074, '2.30', 6, 'Carpentry, home remodeling tasks, light effort'),
(6080, '5.00', 6, 'Caulking, chinking log cabin'),
(6090, '4.50', 6, 'Caulking, except log cabin'),
(6100, '5.00', 6, 'Cleaning gutters'),
(6110, '5.00', 6, 'Excavating garage'),
(6120, '5.00', 6, 'Hanging storm windows'),
(6122, '5.00', 6, 'Hanging sheet rock inside house'),
(6124, '3.00', 6, 'Hammering nails'),
(6126, '2.50', 6, 'Home repair, general, light effort'),
(6127, '4.50', 6, 'Home repair, general, moderate effort'),
(6128, '6.00', 6, 'Home repair, general, vigorous effort'),
(6130, '4.50', 6, 'Laying or removing carpet'),
(6140, '3.80', 6, 'Laying tile or linoleum,repairing appliances'),
(6144, '3.00', 6, 'Repairing appliances'),
(6150, '5.00', 6, 'Painting, outside home (Taylor Code 650)'),
(6160, '3.30', 6, 'Painting inside house,wallpapering, scraping paint'),
(6165, '4.50', 6, 'Painting, (Taylor Code 630)'),
(6167, '3.00', 6, 'Plumbing, general'),
(6170, '3.00', 6, 'Put on and removal of tarp - sailboat'),
(6180, '6.00', 6, 'Roofing'),
(6190, '4.50', 6, 'Sanding floors with a power sander'),
(6200, '4.50', 6, 'Scraping and painting sailboat or powerboat'),
(6205, '2.00', 6, 'Sharpening tools'),
(6210, '5.00', 6, 'Spreading dirt with a shovel'),
(6220, '4.50', 6, 'Washing and waxing hull of sailboat or airplane'),
(6225, '2.00', 6, 'Washing and waxing car'),
(6230, '4.50', 6, 'Washing fence, painting fence, moderate effort'),
(6240, '3.30', 6, 'Wiring, tapping-splicing'),
(7010, '1.00', 7, 'Lying quietly and watching television'),
(7011, '1.30', 7, 'Lying quietly, doing nothing, lying in bed awake, listening to music (not talking or reading)'),
(7020, '1.30', 7, 'Sitting quietly and watching television'),
(7021, '1.30', 7, 'Sitting quietly, general'),
(7022, '1.50', 7, 'Sitting quietly, fidgeting, general, fidgeting hands'),
(7023, '1.80', 7, 'Sitting, fidgeting feet'),
(7024, '1.30', 7, 'Sitting, smoking'),
(7025, '1.50', 7, 'Sitting, listening to music (not talking or reading) or watching a movie in a theater'),
(7026, '1.30', 7, 'Sitting at a desk, resting head in hands'),
(7030, '1.00', 7, 'Sleeping'),
(7040, '1.30', 7, 'Standing quietly, standing in a line'),
(7041, '1.80', 7, 'Standing, fidgeting'),
(7050, '1.30', 7, 'Reclining, writing'),
(7060, '1.30', 7, 'Reclining, talking or talking on phone'),
(7070, '1.30', 7, 'Reclining, reading'),
(7075, '1.00', 7, 'Meditating'),
(8009, '3.30', 8, 'Carrying, loading or stacking wood, loading/unloading or carrying lumber, light-to-moderate effort'),
(8010, '5.50', 8, 'Carrying, loading or stacking wood, loading/unloading or carrying lumber'),
(8019, '4.50', 8, 'Chopping wood, splitting logs, moderate effort'),
(8020, '6.30', 8, 'Chopping wood, splitting logs, vigorous effort'),
(8025, '3.50', 8, 'Clearing light brush, thinning garden, moderate effort'),
(8030, '6.30', 8, 'Clearing brush/land, undergrowth, or ground, hauling branches, wheelbarrow chores, vigorous effort'),
(8040, '5.00', 8, 'Digging sandbox, shoveling sand'),
(8045, '3.50', 8, 'Digging, spading, filling garden, composting, light-to-moderate effort'),
(8050, '5.00', 8, 'Digging, spading, filling garden, compositing, (Taylor Code 590)'),
(8052, '7.80', 8, 'Digging, spading, filling garden, composting, vigorous effort'),
(8055, '2.80', 8, 'Driving tractor'),
(8057, '8.30', 8, 'Felling trees, large size'),
(8058, '5.30', 8, 'Felling trees, small-medium size'),
(8060, '5.80', 8, 'Gardening with heavy power tools, tilling a garden, chain saw'),
(8065, '2.30', 8, 'Gardening, using containers, older adults > 60 years'),
(8070, '4.00', 8, 'Irrigation channels, opening and closing ports'),
(8080, '6.30', 8, 'Laying crushed rock'),
(8090, '5.00', 8, 'Laying sod'),
(8095, '5.50', 8, 'Mowing lawn, general'),
(8100, '2.50', 8, 'Mowing lawn, riding mower (Taylor Code 550)'),
(8110, '6.00', 8, 'Mowing lawn, walk, hand mower (Taylor Code 570)'),
(8120, '5.00', 8, 'Mowing lawn, walk, power mower, moderate or vigorous effort'),
(8125, '4.50', 8, 'Mowing lawn, power mower, light or moderate effort (Taylor Code 590)'),
(8130, '2.50', 8, 'Operating snow blower, walking'),
(8135, '2.00', 8, 'Planting, potting, transplanting seedlings or plants, light effort'),
(8140, '4.30', 8, 'Planting seedlings, shrub, stooping, moderate effort'),
(8145, '4.30', 8, 'Planting crops or garden, stooping, moderate effort'),
(8150, '4.50', 8, 'Planting trees'),
(8160, '3.80', 8, 'Raking lawn or leaves, moderate effort'),
(8165, '4.00', 8, 'Raking lawn (Taylor Code 600)'),
(8170, '4.00', 8, 'Raking roof with snow rake'),
(8180, '3.00', 8, 'Riding snow blower'),
(8190, '4.00', 8, 'Sacking grass, leaves'),
(8192, '5.50', 8, 'Shoveling dirt or mud'),
(8195, '5.30', 8, 'Shoveling snow, by hand, moderate effort'),
(8200, '6.00', 8, 'Shovelling snow, by hand (Taylor Code 610)'),
(8202, '7.50', 8, 'Shoveling snow, by hand, vigorous effort'),
(8210, '4.00', 8, 'Trimming shrubs or trees, manual cutter'),
(8215, '3.50', 8, 'Trimming shrubs or trees, power cutter, using leaf blower, edge, moderate effort'),
(8220, '3.00', 8, 'Walking, applying fertilizer or seeding a lawn, push applicator'),
(8230, '1.50', 8, 'Watering lawn or garden, standing or walking'),
(8239, '3.50', 8, 'Weeding, cultivating garden, light-to-moderate effort'),
(8240, '4.50', 8, 'Weeding, cultivating garden (Taylor Code 580)'),
(8241, '5.00', 8, 'Weeding, cultivating garden, using a hoe, moderate-to-vigorous effort'),
(8245, '3.80', 8, 'Gardening, general, moderate effort'),
(8246, '3.50', 8, 'Picking fruit off trees, picking fruits/vegetables, moderate effort'),
(8248, '4.50', 8, 'Picking fruit off trees, gleaning fruits, picking fruits/vegetables, climbing ladder to pick fruit, vigorous effort'),
(8250, '3.30', 8, 'Implied walking/standing - picking up yard, light, picking flowers or vegetables'),
(8251, '3.00', 8, 'Walking, gathering gardening tools'),
(8255, '5.50', 8, 'Wheelbarrow, pushing garden cart or wheelbarrow'),
(8260, '3.00', 8, 'Yard work, general, light effort'),
(8261, '4.00', 8, 'Yard work, general, moderate effort'),
(8262, '6.00', 8, 'Yard work, general, vigorous effort'),
(9000, '1.50', 9, 'Board game playing, sitting'),
(9005, '2.50', 9, 'Casino gambling, standing'),
(9010, '1.50', 9, 'Card playing, sitting'),
(9013, '1.50', 9, 'Chess game, sitting'),
(9015, '1.50', 9, 'Copying documents, standing'),
(9020, '1.80', 9, 'Drawing, writing, painting, standing'),
(9025, '1.00', 9, 'Laughing, sitting'),
(9030, '1.30', 9, 'Sitting, reading, book, newspaper, etc.'),
(9040, '1.30', 9, 'Sitting, writing, desk work, typing'),
(9045, '1.00', 9, 'Sitting, playing traditional video game, computer game'),
(9050, '1.80', 9, 'Standing, talking in person, on the phone, computer, or text messaging, light effort'),
(9055, '1.50', 9, 'Sitting, talking in person, on the phone, computer, or text messaging, light effort'),
(9060, '1.30', 9, 'Sitting, studying, general, including reading and/or writing, light effort'),
(9065, '1.80', 9, 'Sitting, in class, general, including note-taking or class discussion'),
(9070, '1.80', 9, 'Standing, reading'),
(9071, '2.50', 9, 'Standing, miscellaneous'),
(9075, '1.80', 9, 'Sitting, arts and crafts, carving wood, weaving, spinning wool, light effort'),
(9080, '3.00', 9, 'Sitting, arts and crafts, carving wood, weaving, spinning wool, moderate effort'),
(9085, '2.50', 9, 'Standing, arts and crafts, sand painting, carving, weaving, light effort'),
(9090, '3.30', 9, 'Standing, arts and crafts, sand painting, carving, weaving, moderate effort'),
(9095, '3.50', 9, 'Standing, arts and crafts, sand painting, carving, weaving, vigorous effort'),
(9100, '1.80', 9, 'Retreat/family reunion activities involving sitting, relaxing, talking, eating'),
(9101, '3.00', 9, 'Retreat/family reunion activities involving playing games with children'),
(9105, '2.00', 9, 'Touring/traveling/vacation involving riding in a vehicle'),
(9106, '3.50', 9, 'Touring/traveling/vacation involving walking'),
(9110, '2.50', 9, 'Camping involving standing, walking, sitting, light-to-moderate effort'),
(9115, '1.50', 9, 'Sitting at a sporting event, spectator'),
...
CREATE TABLE `nutrition` (
  ...
  `totalLipid` decimal(5,2) DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `calorieplan` int(2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
ALTER TABLE `exercise`
  ADD CONSTRAINT `exercise_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`userID`);

--
-- Constraints for table `usertogrocery`
--
ALTER TABLE `usertogrocery`
  ADD CONSTRAINT `usertogrocery_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`userID`),
  ADD CONSTRAINT `usertogrocery_ibfk_2` FOREIGN KEY (`fdcid`) REFERENCES `nutrition` (`fdcid`);

--
-- Constraints for table `usertonutrition`
--
ALTER TABLE `usertonutrition`
  ADD CONSTRAINT `usertonutrition_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`userID`),
  ADD CONSTRAINT `usertonutrition_ibfk_2` FOREIGN KEY (`fdcid`) REFERENCES `nutrition` (`fdcid`);

--
-- Constraints for table `usertoplans`
--
ALTER TABLE `usertoplans`
  ADD CONSTRAINT `usertoplans_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`userID`),
  ADD CONSTRAINT `usertoplans_ibfk_2` FOREIGN KEY (`code`) REFERENCES `activity` (`code`);

--
-- Constraints for table `usertoworkout`
--
ALTER TABLE `usertoworkout`
  ADD CONSTRAINT `usertoworkout_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`userID`),
  ADD CONSTRAINT `usertoworkout_ibfk_2` FOREIGN KEY (`code`) REFERENCES `activity` (`code`);
COMMIT;
